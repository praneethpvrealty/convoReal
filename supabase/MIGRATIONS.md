...
Three-digit prefixes through `289` are frozen legacy history. CI rejects any later sequential prefix while continuing to accept the existing files and 14-digit timestamp migrations.
