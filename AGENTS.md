...
| WhatsApp     | `conversations`, `messages`, `message_reactions`, `message_templates`, `whatsapp_config`, `whatsapp_number_profiles`, `whatsapp_number_change_notices`, `whatsapp_meta_flows`, `whatsapp_meta_flow_sessions`, `whatsapp_reply_bridges`, `routing_rules` |
