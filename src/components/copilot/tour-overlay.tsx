...
export function TourOverlay() {
  ...
  const step =
    activeTour && tourStatus === 'showing' ? activeTour.steps[stepIndex] : null;
  ...
  return (
    ...
    >
      ...
      <div
        className="ring-primary pointer-events-none absolute rounded-xl ring-2 transition-all duration-200"
        style={{
          top: rect.top,
          left: rect.left,
          width: rect.width,
      ...
      <div
        ...
        tabIndex={-1}
        className="pointer-events-auto absolute rounded-2xl border border-slate-700 bg-slate-950/95 p-4 shadow-2xl shadow-black/50 backdrop-blur-xl outline-none"
        style={
          mobile
      ...
      >
        ...
        <div className="mt-3 flex items-center justify-between gap-2">
          {isClickStep ? (
            <span className="text-primary text-xs font-semibold motion-safe:animate-pulse">
            ...
            <button
              type="button"
              onClick={advance}
              className="bg-primary text-primary-foreground hover:bg-primary/90 rounded-lg px-4 py-2 text-xs font-bold"
            >
