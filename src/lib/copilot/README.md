...
voice transcriber, and placed back in the composer for review; it is never sent as
a Helper question automatically. The endpoint accepts only bounded audio payloads
and has its own per-minute and daily rate limits.
