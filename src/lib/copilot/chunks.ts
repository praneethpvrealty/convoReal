...
export const CHUNKS: KnowledgeChunk[] = [
  ...
  },
  {
    ...
    kind: 'page',
    body: 'One place per deal once a buyer is commercially active: overview and internal financials, an immutable timeline, a milestone checklist, tasks, the private document folder with draft/reviewed/approved/executed labels and expiry, and invoices. Milestones are separate from the pipeline stage. Nothing here is shared outside your account.',
    keywords: [
  ...
  {
    id: 'deals.limit-stakeholder-links',
    title: 'Sharing a transaction with buyers, sellers or lawyers',
    kind: 'limit',
    body: 'There is no client-facing transaction link yet \u2014 the workspace is internal to your account. To update a buyer or seller today, use the inbox or a personal WhatsApp message and note it on the timeline. Secure per-stakeholder links with their own visibility are planned as the next phase.',
    keywords: [
      'share deal',
      'client link',
      'stakeholder portal',
