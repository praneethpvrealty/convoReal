...
export const CHUNKS: KnowledgeChunk[] = [
  ...
  },
  {
    id: 'deals.folder',
    route: '/deals',
    title: 'Deal folder — invoices and documents',
    kind: 'page',
    body: 'One deal’s money and papers. The Invoices tab raises a brokerage invoice that fills itself in from the deal value, your rate and the linked property, then issues it with the next number in your series and sends it on WhatsApp or email. The Documents tab is the deal’s private folder for Aadhaars, agreements and old sale deeds.',
    keywords: [
      'invoice',
      'bill',
      'brokerage',
