...
describe('sendEnquiryDropoffPrompt', () => {
  it('[INB-009] rejects the listing and asks why with rows the dead-contact gate lets through', async () => {
...
describe('handleEnquiryDropoffReason', () => {
  ...
  it('[INB-009] files the reason on the listing, the timeline and the journey, tells the agent, and thanks the lead', async () => {
    const { db, calls } = stubDb({
