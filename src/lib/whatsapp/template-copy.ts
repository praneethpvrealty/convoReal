...
const BUTTON_LABELS: Record<TemplateButtonAction, Localised> = {
  ...
  approve_request: {
    en: 'Approve request',
    hi: 'अनुरोध मंज़ूर करें',
    kn: 'ವಿನಂತಿ ಅನುಮೋದಿಸಿ',
    ta: 'கோரிக்கையை ஏற்கவும்',
    te: 'అభ్యర్థన ఆమోదించండి',
  ...
  decline_request: {
    ...
    te: 'అభ్యర్థన తిరస్కరించు',
    ml: 'അപേക്ഷ നിരസിക്കുക',
    mr: 'विनंती नाकारा',
  },
  approve_access: {
    en: 'Approve access',
    hi: 'पहुँच मंज़ूर करें',
    kn: 'ಪ್ರವೇಶ ಅನುಮೋದಿಸಿ',
    ta: 'அணுகலை ஏற்கவும்',
    te: 'యాక్సెస్ ఆమోదించండి',
  ...
  reject_access: {
    ...
    kn: 'ಪ್ರವೇಶ ನಿರಾಕರಿಸಿ',
    ta: 'அணுகலை நிராகரி',
    te: 'యాక్సెస్ తిరస్కరించు',
    ml: 'പ്രവേശനം നിരസിക്കുക',
    mr: 'प्रवेश नाकारा',
  },
  timeline_unsure: {
    en: "Can't say yet",
  ...
  portfolio_sign_in: {
    en: 'Sign in to Portfolio',
    hi: 'पोर्टफोलियो में साइन इन',
    kn: 'Portfolio ಸೈನ್ ಇನ್',
    ta: 'Portfolio உள்நுழைவு',
    te: 'Portfolio సైన్ ఇన్',
    ml: 'Portfolio സൈൻ ഇൻ',
    mr: 'पोर्टफोलिओ साइन इन',
  },
  acknowledge_update: {
    en: 'Noted, thanks',
    hi: 'ठीक है, धन्यवाद',
...
> = {
  ...
  portfolio_access: {
    ...
    hi: {
      body: lines(
        'नमस्ते {{1}}, यह {{2}} की ओर से खाते से जुड़ी सूचना है।',
        '',
        'आपका पोर्टफोलियो अब सक्रिय है और इस WhatsApp नंबर से जुड़ा है। इसमें आपके लिए रखे गए रिकॉर्ड दिखते हैं: खरीदार के रूप में आपकी आवश्यकता से मेल खाती प्रॉपर्टी और आपकी शॉर्टलिस्ट, या मालिक के रूप में आपकी प्रॉपर्टी पर आई पूछताछ, साइट विज़िट और बोलियाँ।',
        '',
    ...
    kn: {
      body: lines(
        'ನಮಸ್ಕಾರ {{1}}, ಇದು {{2}} ಕಡೆಯಿಂದ ಖಾತೆ ಸೂಚನೆ.',
        '',
        'ನಿಮ್ಮ Portfolio ಈಗ ಸಕ್ರಿಯವಾಗಿದೆ ಮತ್ತು ಈ WhatsApp ಸಂಖ್ಯೆಗೆ ಲಿಂಕ್ ಆಗಿದೆ. ನಿಮಗಾಗಿ ಇಟ್ಟಿರುವ ದಾಖಲೆಗಳು ಇದರಲ್ಲಿ ಕಾಣುತ್ತವೆ: ಖರೀದಿದಾರರಾಗಿ ನಿಮ್ಮ ಅಗತ್ಯಕ್ಕೆ ಹೊಂದುವ ಆಸ್ತಿಗಳು ಮತ್ತು ನಿಮ್ಮ ಶಾರ್ಟ್‌ಲಿಸ್ಟ್, ಅಥವಾ ಮಾಲೀಕರಾಗಿ ನಿಮ್ಮ ಆಸ್ತಿಯ ಮೇಲಿನ ವಿಚಾರಣೆಗಳು, ಸೈಟ್ ಭೇಟಿಗಳು ಮತ್ತು ಬಿಡ್‌ಗಳು.',
        '',
    ...
    ml: {
      body: lines(
        'നമസ്കാരം {{1}}, ഇത് {{2}} അയക്കുന്ന അക്കൗണ്ട് അറിയിപ്പാണ്.',
        '',
        'നിങ്ങളുടെ Portfolio ഇപ്പോൾ സജീവമാണ്, ഈ WhatsApp നമ്പറുമായി ബന്ധിപ്പിച്ചിരിക്കുന്നു. നിങ്ങൾക്കായി സൂക്ഷിച്ചിരിക്കുന്ന രേഖകൾ ഇതിൽ കാണാം: വാങ്ങുന്നയാളെന്ന നിലയിൽ നിങ്ങളുടെ ആവശ്യത്തിന് ചേരുന്ന വസ്തുക്കളും നിങ്ങളുടെ ഷോർട്ട്‌ലിസ്റ്റും, അല്ലെങ്കിൽ ഉടമയെന്ന നിലയിൽ നിങ്ങളുടെ വസ്തുവിന്മേലുള്ള അന്വേഷണങ്ങൾ, സൈറ്റ് സന്ദർശനങ്ങൾ, ബിഡുകൾ.',
        '',
  ...
  requirement_review: {
    ...
    hi: {
      body: lines(
        'नमस्ते {{1}}, यह {{2}} की ओर से आपकी पूछताछ में दर्ज प्रॉपर्टी आवश्यकता की पुष्टि का अनुरोध है।',
        '',
    ...
    kn: {
      body: lines(
        'ನಮಸ್ಕಾರ {{1}}, ನಿಮ್ಮ ವಿಚಾರಣೆಯಲ್ಲಿ ದಾಖಲಾದ ಆಸ್ತಿ ಅಗತ್ಯವನ್ನು ಪರಿಶೀಲಿಸಲು {{2}} ಕಡೆಯಿಂದ ಈ ವಿನಂತಿ.',
        '',
    ...
    ta: {
      body: lines(
        'வணக்கம் {{1}}, உங்கள் விசாரணையில் பதிவான சொத்து தேவையைச் சரிபார்க்க {{2}} சார்பாக இந்தக் கோரிக்கை அனுப்பப்பட்டுள்ளது.',
        '',
    ...
    ml: {
      body: lines(
        'നമസ്കാരം {{1}}, നിങ്ങളുടെ അന്വേഷണത്തിൽ രേഖപ്പെടുത്തിയ വസ്തു ആവശ്യം പരിശോധിക്കാൻ {{2}} അയക്കുന്ന അഭ്യർത്ഥനയാണിത്.',
        '',
    ...
    mr: {
      body: lines(
        'नमस्कार {{1}}, तुमच्या चौकशीत नोंदवलेल्या मालमत्ता गरजेची पडताळणी करण्यासाठी {{2}} कडून ही विनंती आहे.',
        '',
  ...
  location_consent_request: {
    ...
    hi: {
      body: lines(
        'स्थान पहुँच सहमति अनुरोध',
        '',
        'नमस्ते {{1}}, आपके साझा लिंक से {{2}} देखने वाले एक संपर्क ने सुरक्षित प्रॉपर्टी पहुँच माँगी है।',
        '',
        'अनुरोधकर्ता: {{3}}',
        '',
    ...
    kn: {
      body: lines(
        'ಸ್ಥಳ ಪ್ರವೇಶ ಸಮ್ಮತಿ ವಿನಂತಿ',
        '',
        'ನಮಸ್ಕಾರ {{1}}, ನಿಮ್ಮ ಹಂಚಿದ ಲಿಂಕ್ ಮೂಲಕ {{2}} ನೋಡಿದ ಸಂಪರ್ಕವು ಸುರಕ್ಷಿತ ಆಸ್ತಿ ಪ್ರವೇಶವನ್ನು ಕೇಳಿದೆ.',
        '',
        'ವಿನಂತಿದಾರ: {{3}}',
        '',
    ...
    ta: {
      body: lines(
        'இட அணுகல் ஒப்புதல் கோரிக்கை',
        '',
        'வணக்கம் {{1}}, நீங்கள் பகிர்ந்த இணைப்பில் {{2}} பார்த்த ஒருவர் பாதுகாக்கப்பட்ட சொத்து அணுகலைக் கோரியுள்ளார்.',
        '',
        'கோரியவர்: {{3}}',
        '',
    ...
    ml: {
      body: lines(
        'സ്ഥല പ്രവേശന സമ്മത അഭ്യർത്ഥന',
        '',
        'നമസ്കാരം {{1}}, നിങ്ങൾ പങ്കിട്ട ലിങ്കിലൂടെ {{2}} കണ്ട ഒരാൾ സുരക്ഷിത വസ്തു പ്രവേശനം അഭ്യർത്ഥിച്ചു.',
        '',
        'അഭ്യർത്ഥകൻ: {{3}}',
        '',
    ...
    mr: {
      body: lines(
        'स्थान प्रवेश संमती विनंती',
        '',
        'नमस्कार {{1}}, तुम्ही शेअर केलेल्या लिंकवरून {{2}} पाहिलेल्या संपर्काने सुरक्षित मालमत्ता प्रवेश मागितला आहे.',
        '',
        'विनंतीकर्ता: {{3}}',
        '',
  ...
  location_owner_decision: {
    ...
    hi: {
      body: lines(
        'सुरक्षित प्रॉपर्टी पहुँच निर्णय',
        '',
        'अनुरोध: {{1}}',
        'प्रॉपर्टी: {{2}}',
        'अनुरोधकर्ता: {{3}}',
    ...
    ta: {
      body: lines(
        'பாதுகாக்கப்பட்ட சொத்து அணுகல் முடிவு',
        '',
        'கோரிக்கை: {{1}}',
        'சொத்து: {{2}}',
        'கோரியவர்: {{3}}',
    ...
    ml: {
      body: lines(
        'സുരക്ഷിത വസ്തു പ്രവേശന തീരുമാനം',
        '',
        'അഭ്യർത്ഥന: {{1}}',
        'വസ്തു: {{2}}',
        'അഭ്യർത്ഥകൻ: {{3}}',
    ...
    mr: {
      body: lines(
        'सुरक्षित मालमत्ता प्रवेश निर्णय',
        '',
        'विनंती: {{1}}',
        'मालमत्ता: {{2}}',
        'विनंतीकर्ता: {{3}}',
