...
export const EN = {
  ...
  'nav.guidanceValue': 'Guidance value',
  'nav.calendar': 'Calendar',
  'nav.journey': 'Journey',
  'nav.transactions': 'Deals',
...
const HI: Catalogue = {
  ...
  'nav.inbox': 'इनबॉक्स',
  'nav.groups': 'व्हाट्सऐप समूह',
  'nav.contacts': 'संपर्क',
  'nav.inventory': 'इन्वेंटरी',
  'nav.liaisons': 'सेवा प्रदाता',
  'nav.guidanceValue': 'मार्गदर्शन मूल्य',
  'nav.calendar': 'कैलेंडर',
  'nav.journey': 'जर्नी',
  'nav.transactions': 'डील्स',
...
const ML: Catalogue = {
  ...
  'nav.inbox': 'ഇൻബോക്സ്',
  'nav.groups': 'വാട്ട്‌സ്ആപ്പ് ഗ്രൂപ്പുകൾ',
  'nav.contacts': 'ബന്ധങ്ങൾ',
  'nav.inventory': 'സ്വത്ത് പട്ടിക',
  'nav.liaisons': 'സേവന ദാതാക്കൾ',
  'nav.guidanceValue': 'ന്യായവില',
  'nav.calendar': 'കലണ്ടർ',
  'nav.journey': 'യാത്ര',
  'nav.transactions': 'ഡീലുകൾ',
...
const MR: Catalogue = {
  ...
  'nav.inbox': 'इनबॉक्स',
  'nav.groups': 'व्हॉट्सॲप गट',
  'nav.contacts': 'संपर्क',
  'nav.inventory': 'मालमत्ता यादी',
  'nav.liaisons': 'सेवा पुरवठादार',
  'nav.guidanceValue': 'मार्गदर्शक मूल्य',
